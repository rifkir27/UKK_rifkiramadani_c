...
<div class="mb-6 flex justify-between items-center">
    <div>
        ...
        <p class="text-gray-600">Daftar petugas perpustakaan</p>
    </div>
...
<div class="bg-white rounded-xl shadow p-6">
    <div class="overflow-x-auto">
        <table class="w-full text-left">
            <thead><tr class="bg-gray-50"><th class="px-4 py-3">Nama</th><th class="px-4 py-3">Email</th><th class="px-4 py-3">Telepon</th><th class="px-4 py-3">Status</th><th class="px-4 py-3">Aksi</th></tr></thead>
            <tbody>
                ...
                @empty<tr><td colspan="5" class="px-4 py-6 text-center text-gray-500">Belum ada petugas</td></tr>@endforelse
            </tbody>
        </table>
    </div>
</div>
