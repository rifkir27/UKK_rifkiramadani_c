...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Tambah Petugas</h1>
    <p class="text-gray-600">Tambah petugas perpustakaan baru</p>
</div>

<div class="bg-white rounded-xl shadow p-6 max-w-lg">
    <form action="{{ route('admin.users.store-petugas') }}" method="POST">
        @csrf
        <div class="mb-4">
