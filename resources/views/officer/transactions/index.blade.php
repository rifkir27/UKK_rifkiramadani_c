...
<div class="mb-6">
    ...
    <p class="text-gray-600">Semua transaksi peminjaman dan pengembalian</p>
</div>

<div class="bg-white rounded-xl shadow p-6">
    <div class="overflow-x-auto">
        <table class="w-full text-left">
            <thead><tr class="bg-gray-50"><th class="px-4 py-3">Kode</th><th class="px-4 py-3">Siswa</th><th class="px-4 py-3">Buku</th><th class="px-4 py-3">Pinjam</th><th class="px-4 py-3">Jatuh Tempo</th><th class="px-4 py-3">Status</th></tr></thead>
            <tbody>
                ...
                <tr class="border-t">
                    ...
                    <td class="px-4 py-3 {{ \Carbon\Carbon::parse($t->due_date)->isPast() && $t->status=='borrowed' ? 'text-red-600 font-bold' : '' }}">{{ $t->due_date?->format('d/m/Y') }}</td>
                    <td class="px-4 py-3">
                ...
                @empty<tr><td colspan="6" class="px-4 py-6 text-center text-gray-500">Belum ada transaksi</td></tr>@endforelse
            </tbody>
        </table>
    </div>
</div>
